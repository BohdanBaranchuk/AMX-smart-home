MODULE_NAME='TS3_ErrSensor'(DEV vdv_Macros, integer ID,
		    DEV TS3,DEV TS3_getT, DEV Tablet[], sinteger gettedTemp, integer settedTemp,integer gettedMode , 
...
LEVEL_EVENT[TS3_getT,getLevel]			// read temp from TS3
{
